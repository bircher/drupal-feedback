...
/**
 * @file
 * Contains \Drupal\feedback\Entity\FeedbackMessage.
 */
...
//      ->setRequired(TRUE)
//      ->setDefaultValueCallback('Drupal\feedback\Entity\FeedbackMessage::getCurrentPath')
      ->setDisplayOptions('view', array(
        'label' => 'inline',
        'weight' => 4,
      ))
...
//    $path = 'internal:' . \Drupal::service('path.current')->getPath();
//    if ($query = \Drupal::request()->getQueryString()) {
//      $path .= '?' . $query;
//    }
//    return $path;
//  }
